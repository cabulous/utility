 ...
 */
export const Countdown = function(el, options) {
  ...
  this.getDiffDate = function() {
    let diff = (this.options.date.getTime() - Date.now() +
      this.options.offset) / 1000;
   ...
   * @param  {Number} aNum    Input number
   * @param  {Number} [length] Length of the desired output
   * @return {String}        String of the desired length with leading zeros
   */
  this.leadingZeros = function(aNum, length) {
    length = length || 2;
    const num = String(aNum);
   ...
   * @param  {Date | string | number} newDate Date object or a String/Number that can be passed to the Date constructor
